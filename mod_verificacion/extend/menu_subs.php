...
<ul id="menu" class="side-nav fixed">
  ...
  <li><div class="divider"></div></li>
  <li><a href="../subdireccion/index.php"><i class="material-icons">find_in_page</i>VERIFICACIONES A REV.</a></li>
  <li><div class="divider"></div></li>
  <li><a href="../subdireccion/ver_proceso.php"><i class="material-icons">done_all</i>VERIFICACIONES REV.</a></li>
  <li><div class="divider"></div></li>
