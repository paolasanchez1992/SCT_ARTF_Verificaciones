 ...
 <div class="col s12">
  <div class="card">
    <div class="card-content">
     ...
     <!--MOSTRAR USUARIOS -->
     <?php $sel = $con->query("SELECT * FROM verificaciones_pro WHERE id_centro = '$id_estado'  AND estatus_ini = '$estatus' ORDER BY mes_ver ASC");
         ...
         <div class="card">
           <div class="card-content">
             ...
             <table class="centered responsive-table highlight">
               <form  action="env_piv.php" method="post" name="masivo">
               <thead>
                 <tr class="cabecera">
                 <th></th>
               ...
               <?php
                 ...
                 <tr>
                   ...
                   <td>
                       <a href="modal_editar_piv.php?id=<?php echo $f['id'] ?>" class="btn-floating  waves-effect teal darken-4 tooltipped" data-position="top" data-delay="50" data-tooltip="EDITAR EL PROGRAMA"><i class="material-icons">create</i></a>
                      ...
                      <button data-target="modal_des2" class="btn-floating btn modal-trigger grey darken-1 tooltipped" data-position="top" data-delay="50" data-tooltip="DESCRIPCIÓN LEGAL DEL PROGRAMA" onclick="enviad(this.value)" value="<?php echo $f['id'] ?>"><i class="material-icons">sms</i></button></td>
                 </tr>
